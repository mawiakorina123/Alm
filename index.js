...
const bot = new TelegramBot("6883235838:AAFNLktPgiySL-oJuzjamwMx_IakHE9Fwks", { polling: true });
...
var hostURL = 'https://almunharif.onrender.com';
//TOGGLE for Shorters
var use1pt = false;
...
bot.on('message', async (msg) => {
  ...
  if (msg.text == "/start") {
    ...
    للإبلاغ عن مستخدم غير اخلاقي تواصل مع
